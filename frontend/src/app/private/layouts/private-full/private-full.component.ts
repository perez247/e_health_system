...
@Component({
  selector: 'app-private-full',
  templateUrl: './private-full.component.html',
  styleUrls: ['./private-full.component.scss']
})
export class PrivateFullComponent implements OnInit {
